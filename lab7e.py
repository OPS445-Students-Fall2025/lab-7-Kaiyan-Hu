#!/usr/bin/env python3
# Student ID: 178557236
class Time:
    """Simple object type for time of the day.
    data attributes: hour, minute, second
    function attributes: __init__, __str_, __repr__
    ...
    def sum_times(self, t2):
        ...
        """Change this become object method for our time object (refer to lab7c.py and change_time() method)"""
    ...
    def time_to_sec(self):
        '''convert a time object to a single integer representing the number
        of second from mid-night'''
